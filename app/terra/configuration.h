...
#define CONFIGURATTION_WINDOW_DATA_SIZE 
...
/**
 * @brief This struct contains the configuration of the Terra application
 * These values are saved in the configuration.
 * Note: since this is serialised and stored in flash it must not contain any pointers and be completely defined at compile-time
 */
...
*/
#define CONFIGURATION_TERRA_CONFIGURATION_SIZE sizeof(TerraConfiguration)
